...
const ADMIN_COMPANY_USERS = [
  ...
  // Company Users - Construction Companies
  {
    ...
    description:
      "სრული სამშენებლო მომსახურება - საცხოვრებელი და კომერციული ობიექტების მშენებლობა 15 წლიანი გამოცდილებით.",
  ...
  },
  {
    ...
    description:
      "ბინებისა და სახლების რემონტი ევროპული ხარისხით. კოსმეტიკური და კაპიტალური რემონტი.",
  ...
  // Company Users - Service Agencies
  {
    ...
    description:
      "ელექტრიკა, სანტექნიკა, კონდიციონირება და სხვა საყოფაცხოვრებო სერვისები 24/7 რეჟიმში.",
    categories: ["services"],
    subcategories: [
      "electrical-works",
      "plumbing",
  ...
  },
  {
    ...
    description:
      "თანამედროვე ინტერიერის დიზაინი, 3D ვიზუალიზაცია და ავტორის ზედამხედველობა.",
    categories: ["design"],
  ...
  },
  {
    ...
    description:
      "ბათუმსა და აჭარის რეგიონში სამშენებლო და სარემონტო სამუშაოები.",
    categories: ["renovation", "construction"],
