...
const userSchema = new mongoose.Schema(
  {
    ...
    pricingModel: {
      type: String,
      enum: ["hourly", "daily", "sqm", "project_based", "from"],
    },
...
const DEMO_USERS = [
  ...
  // Professionals
  {
    ...
    description:
      "Professional renovation services with 8 years of experience. Full and cosmetic renovations.",
    yearsExperience: 8,
  ...
  },
  {
    ...
    description:
      "Creative interior designer specializing in modern and minimalist spaces. 3D visualization included.",
    yearsExperience: 6,
  ...
  },
  {
    ...
    title: "Architect",
    description:
      "Licensed architect with expertise in residential projects and full project documentation.",
    yearsExperience: 12,
  ...
  },
  {
    ...
    description:
      "Specialized in exterior and landscape design for coastal properties.",
    yearsExperience: 5,
  ...
  },
  {
    ...
    description:
      "Complete renovation solutions including electrical, plumbing, and finishing works.",
    yearsExperience: 10,
  ...
  },
  {
    ...
    description:
      "Certified electrician specializing in smart home installations and electrical renovations.",
    yearsExperience: 7,
    serviceAreas: ["tbilisi"],
    pricingModel: "hourly",
    basePrice: 50,
  ...
  },
  {
    ...
    description:
      "Expert in kitchen and bathroom renovations with modern designs.",
    yearsExperience: 9,
  ...
  },
  {
    ...
    description:
      "Full-service design studio offering interior design, 3D visualization, and architectural services.",
    yearsExperience: 15,
  ...
  },
  {
    ...
    description:
      "Professional plumbing and heating/cooling system installation and repair.",
    yearsExperience: 11,
    serviceAreas: ["tbilisi", "rustavi"],
    pricingModel: "hourly",
    basePrice: 40,
  ...
  },
  {
    ...
    description:
      "Custom furniture design and interior styling. Creating unique, functional spaces.",
    yearsExperience: 4,
    serviceAreas: ["tbilisi"],
    pricingModel: "project_based",
    basePrice: 300,
...
async function getNextUid(): Promise<number> {
  const lastUser = await User.findOne({ uid: { $exists: true } })
    .sort({ uid: -1 })
    .exec();
