...
function buildAddon(
  a: { key: string; labelKey: string; promptKey: string; basePrice: number; unit: string; unitLabelKey: string; iconName?: string },
  en: Record<string, string>,
  ka: Record<string, string>,
  ru: Record<string, string>,
) {
...
const cleaningChemicalsAddon = {
  ...
  promptKey: 'catalog.addon_cleaningChemicalsPrompt', basePrice: 12,
...
const stainProtectionAddon = {
  ...
  promptKey: 'catalog.addon_stainProtectionPrompt', basePrice: 30,
...
const packingMaterialsAddon = {
  ...
  promptKey: 'catalog.addon_packingMaterialsPrompt', basePrice: 40,
...
const standardCleaningVariants = [
  {
    ...
    additionalServices: [
      { key: 'std_apt_ironing', labelKey: 'catalog.ironing', basePrice: 20, unit: 'hour', unitLabelKey: 'catalog.unitHour' },
      { key: 'std_apt_fridge', labelKey: 'catalog.fridgeCleaning', basePrice: 25, unit: 'piece', unitLabelKey: 'catalog.unitPiece', maxQuantity: 2 },
      { key: 'std_apt_cupboard', labelKey: 'catalog.cupboardCleaning', basePrice: 15, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      { key: 'std_apt_laundry', labelKey: 'catalog.laundryCleaning', basePrice: 20, unit: 'set', unitLabelKey: 'catalog.unitSet' },
    ],
  },
  {
    key: 'studio', labelKey: 'catalog.variant_studio',
    services: [
      { key: 'std_st_kitchen', labelKey: 'catalog.kitchenCleaning', basePrice: 30, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 1 },
      { key: 'std_st_bathroom', labelKey: 'catalog.bathroomCleaning', basePrice: 25, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 1 },
      { key: 'std_st_living', labelKey: 'catalog.livingRoomCleaning', basePrice: 35, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 1 },
      { key: 'std_st_bedroom', labelKey: 'catalog.bedroomCleaning', basePrice: 30, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 1 },
      { key: 'std_st_cabinet', labelKey: 'catalog.cabinetRoom', basePrice: 25, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 1 },
      { key: 'std_st_terrace', labelKey: 'catalog.terraceCleaning', basePrice: 5, unit: 'sqm', unitLabelKey: 'catalog.unitSqm' },
    ],
    addons: [cleaningChemicalsAddon],
    additionalServices: [
      { key: 'std_st_ironing', labelKey: 'catalog.ironing', basePrice: 20, unit: 'hour', unitLabelKey: 'catalog.unitHour' },
      { key: 'std_st_fridge', labelKey: 'catalog.fridgeCleaning', basePrice: 25, unit: 'piece', unitLabelKey: 'catalog.unitPiece', maxQuantity: 1 },
      { key: 'std_st_cupboard', labelKey: 'catalog.cupboardCleaning', basePrice: 15, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      { key: 'std_st_laundry', labelKey: 'catalog.laundryCleaning', basePrice: 20, unit: 'set', unitLabelKey: 'catalog.unitSet' },
    ],
  },
];
...
const deepCleaningVariants = [
  {
    key: 'apartment', labelKey: 'catalog.variant_apartment',
    services: [
      { key: 'deep_apt_kitchen', labelKey: 'catalog.kitchenCleaning', basePrice: 45, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 2 },
      { key: 'deep_apt_bathroom', labelKey: 'catalog.bathroomCleaning', basePrice: 40, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 3 },
      { key: 'deep_apt_living', labelKey: 'catalog.livingRoomCleaning', basePrice: 50, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 2 },
      { key: 'deep_apt_bedroom', labelKey: 'catalog.bedroomCleaning', basePrice: 45, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 5 },
      { key: 'deep_apt_cabinet', labelKey: 'catalog.cabinetRoom', basePrice: 40, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 2 },
      { key: 'deep_apt_terrace', labelKey: 'catalog.terraceCleaning', basePrice: 8, unit: 'sqm', unitLabelKey: 'catalog.unitSqm' },
      { key: 'deep_apt_window', labelKey: 'catalog.windowCleaning', basePrice: 12, unit: 'window', unitLabelKey: 'catalog.unitWindow', maxQuantity: 20 },
      { key: 'deep_apt_double_window', labelKey: 'catalog.doubleWindowCleaning', basePrice: 18, unit: 'window', unitLabelKey: 'catalog.unitWindow', maxQuantity: 10 },
      { key: 'deep_apt_glass_door', labelKey: 'catalog.glassDoorCleaning', basePrice: 20, unit: 'piece', unitLabelKey: 'catalog.unitPiece', maxQuantity: 5 },
      { key: 'deep_apt_stained_glass', labelKey: 'catalog.stainedGlassCleaning', basePrice: 25, unit: 'piece', unitLabelKey: 'catalog.unitPiece', maxQuantity: 5 },
    ],
    addons: [cleaningChemicalsAddon],
    additionalServices: [
      { key: 'deep_apt_ironing', labelKey: 'catalog.ironing', basePrice: 20, unit: 'hour', unitLabelKey: 'catalog.unitHour' },
      { key: 'deep_apt_fridge', labelKey: 'catalog.fridgeCleaning', basePrice: 25, unit: 'piece', unitLabelKey: 'catalog.unitPiece', maxQuantity: 2 },
      { key: 'deep_apt_cupboard', labelKey: 'catalog.cupboardCleaning', basePrice: 15, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      { key: 'deep_apt_laundry', labelKey: 'catalog.laundryCleaning', basePrice: 20, unit: 'set', unitLabelKey: 'catalog.unitSet' },
    ],
  },
  {
    key: 'studio', labelKey: 'catalog.variant_studio',
    services: [
      { key: 'deep_st_kitchen', labelKey: 'catalog.kitchenCleaning', basePrice: 40, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 1 },
      { key: 'deep_st_bathroom', labelKey: 'catalog.bathroomCleaning', basePrice: 35, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 1 },
      { key: 'deep_st_living', labelKey: 'catalog.livingRoomCleaning', basePrice: 45, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 1 },
      { key: 'deep_st_bedroom', labelKey: 'catalog.bedroomCleaning', basePrice: 40, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 1 },
      { key: 'deep_st_cabinet', labelKey: 'catalog.cabinetRoom', basePrice: 35, unit: 'room', unitLabelKey: 'catalog.unitRoom', maxQuantity: 1 },
      { key: 'deep_st_terrace', labelKey: 'catalog.terraceCleaning', basePrice: 8, unit: 'sqm', unitLabelKey: 'catalog.unitSqm' },
      { key: 'deep_st_window', labelKey: 'catalog.windowCleaning', basePrice: 12, unit: 'window', unitLabelKey: 'catalog.unitWindow', maxQuantity: 10 },
      { key: 'deep_st_double_window', labelKey: 'catalog.doubleWindowCleaning', basePrice: 18, unit: 'window', unitLabelKey: 'catalog.unitWindow', maxQuantity: 5 },
      { key: 'deep_st_glass_door', labelKey: 'catalog.glassDoorCleaning', basePrice: 20, unit: 'piece', unitLabelKey: 'catalog.unitPiece', maxQuantity: 3 },
      { key: 'deep_st_stained_glass', labelKey: 'catalog.stainedGlassCleaning', basePrice: 25, unit: 'piece', unitLabelKey: 'catalog.unitPiece', maxQuantity: 3 },
    ],
    addons: [cleaningChemicalsAddon],
    additionalServices: [
      { key: 'deep_st_ironing', labelKey: 'catalog.ironing', basePrice: 20, unit: 'hour', unitLabelKey: 'catalog.unitHour' },
      { key: 'deep_st_fridge', labelKey: 'catalog.fridgeCleaning', basePrice: 25, unit: 'piece', unitLabelKey: 'catalog.unitPiece', maxQuantity: 1 },
      { key: 'deep_st_cupboard', labelKey: 'catalog.cupboardCleaning', basePrice: 15, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      { key: 'deep_st_laundry', labelKey: 'catalog.laundryCleaning', basePrice: 20, unit: 'set', unitLabelKey: 'catalog.unitSet' },
    ],
  },
];
...
const windowCleaningVariants = [
  {
    ...
    services: [
      { key: 'wc_reg_window', labelKey: 'catalog.windowCleaning', basePrice: 8, unit: 'window', unitLabelKey: 'catalog.unitWindow' },
      { key: 'wc_reg_double_window', labelKey: 'catalog.doubleWindowCleaning', basePrice: 12, unit: 'window', unitLabelKey: 'catalog.unitWindow' },
      { key: 'wc_reg_glass_door', labelKey: 'catalog.glassDoorCleaning', basePrice: 15, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      { key: 'wc_reg_stained_glass', labelKey: 'catalog.stainedGlassCleaning', basePrice: 18, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
    ],
  },
  {
    key: 'after_renovation', labelKey: 'catalog.variant_afterRenovation',
    services: [
      { key: 'wc_reno_window', labelKey: 'catalog.windowCleaning', basePrice: 12, unit: 'window', unitLabelKey: 'catalog.unitWindow' },
      { key: 'wc_reno_double_window', labelKey: 'catalog.doubleWindowCleaning', basePrice: 18, unit: 'window', unitLabelKey: 'catalog.unitWindow' },
      { key: 'wc_reno_glass_door', labelKey: 'catalog.glassDoorCleaning', basePrice: 22, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      { key: 'wc_reno_stained_glass', labelKey: 'catalog.stainedGlassCleaning', basePrice: 25, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
    ],
  },
];

function buildMovingVariant(vKey: string, labelKey: string, prices: { load: number; unload: number; transport: number; pack: number; unpack: number }) {
  return {
    key: vKey, labelKey,
    services: [
      { key: `${vKey}_loading`, labelKey: 'catalog.loading', basePrice: prices.load, unit: 'set', unitLabelKey: 'catalog.unitSet', maxQuantity: 1 },
      { key: `${vKey}_unloading`, labelKey: 'catalog.unloading', basePrice: prices.unload, unit: 'set', unitLabelKey: 'catalog.unitSet', maxQuantity: 1 },
      { key: `${vKey}_transport`, labelKey: 'catalog.transport', basePrice: prices.transport, unit: 'set', unitLabelKey: 'catalog.unitSet', maxQuantity: 1 },
      { key: `${vKey}_packing`, labelKey: 'catalog.packing', basePrice: prices.pack, unit: 'set', unitLabelKey: 'catalog.unitSet', maxQuantity: 1 },
      { key: `${vKey}_unpacking`, labelKey: 'catalog.unpacking', basePrice: prices.unpack, unit: 'set', unitLabelKey: 'catalog.unitSet', maxQuantity: 1 },
    ],
    addons: [packingMaterialsAddon],
    additionalServices: [
      { key: `${vKey}_piano`, labelKey: 'catalog.pianoMoving', basePrice: 200, unit: 'piece', unitLabelKey: 'catalog.unitPiece', maxQuantity: 1 },
      { key: `${vKey}_safe`, labelKey: 'catalog.safeMoving', basePrice: 150, unit: 'piece', unitLabelKey: 'catalog.unitPiece', maxQuantity: 1 },
      { key: `${vKey}_disassembly`, labelKey: 'catalog.disassemblyReassembly', basePrice: 50, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
    ],
  };
}

const movingVariants = [
  buildMovingVariant('mv_studio', 'catalog.variant_studio', { load: 80, unload: 80, transport: 100, pack: 60, unpack: 60 }),
  buildMovingVariant('mv_1r', 'catalog.variant_1room', { load: 120, unload: 120, transport: 150, pack: 80, unpack: 80 }),
  buildMovingVariant('mv_2r', 'catalog.variant_2room', { load: 160, unload: 160, transport: 200, pack: 100, unpack: 100 }),
  buildMovingVariant('mv_3r', 'catalog.variant_3room', { load: 200, unload: 200, transport: 250, pack: 120, unpack: 120 }),
  buildMovingVariant('mv_h', 'catalog.variant_house', { load: 300, unload: 300, transport: 400, pack: 180, unpack: 180 }),
];
...
const SERVICE_CATALOG = [
  {
    ...
    subcategories: [
      { key: 'rental_host_cleaning', labelKey: 'catalog.rentalHostCleaning', descriptionKey: 'catalog.rentalHostCleaningDesc', iconName: 'Home', priceRange: { min: 50 },
        services: [
          { key: 'rh_up_to_40', labelKey: 'catalog.areaUpTo40', basePrice: 50, unit: 'set', unitLabelKey: 'catalog.unitSet', maxQuantity: 1 },
          { key: 'rh_41_to_70', labelKey: 'catalog.area41to70', basePrice: 65, unit: 'set', unitLabelKey: 'catalog.unitSet', maxQuantity: 1 },
          { key: 'rh_71_to_96', labelKey: 'catalog.area71to96', basePrice: 75, unit: 'set', unitLabelKey: 'catalog.unitSet', maxQuantity: 1 },
        ],
        addons: [cleaningChemicalsAddon],
        additionalServices: [
          { key: 'rh_curtain_wash_iron', labelKey: 'catalog.curtainWashingIroning', basePrice: 15, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
        ],
      },
      { key: 'hourly_cleaning', labelKey: 'catalog.hourlyCleaning', descriptionKey: 'catalog.hourlyCleaningDesc', iconName: 'Clock', priceRange: { min: 45 },
        services: [
          { key: 'hc_2_hours', labelKey: 'catalog.duration2Hours', basePrice: 45, unit: 'set', unitLabelKey: 'catalog.unitSet', maxQuantity: 1 },
        ],
        addons: [cleaningChemicalsAddon],
      },
      ...
      { key: 'ironing_service', labelKey: 'catalog.ironingServiceSub', descriptionKey: 'catalog.ironingServiceDesc', iconName: 'Shirt', priceRange: { min: 15 },
        services: [
          { key: 'iron_1_hour', labelKey: 'catalog.duration1Hour', basePrice: 15, unit: 'set', unitLabelKey: 'catalog.unitHour', maxQuantity: 1 },
          { key: 'iron_2_hours', labelKey: 'catalog.duration2Hours', basePrice: 25, unit: 'set', unitLabelKey: 'catalog.unitHour', maxQuantity: 1 },
          { key: 'iron_3_hours', labelKey: 'catalog.duration3Hours', basePrice: 35, unit: 'set', unitLabelKey: 'catalog.unitHour', maxQuantity: 1 },
          { key: 'iron_4_hours', labelKey: 'catalog.duration4Hours', basePrice: 45, unit: 'set', unitLabelKey: 'catalog.unitHour', maxQuantity: 1 },
        ],
      },
      { key: 'entrance_cleaning', labelKey: 'catalog.entranceCleaning', descriptionKey: 'catalog.entranceCleaningDesc', iconName: 'Building', priceRange: { min: 15 },
        services: [
          { key: 'ent_per_floor', labelKey: 'catalog.floorCleaning', basePrice: 15, unit: 'floor', unitLabelKey: 'catalog.unitFloor' },
        ],
      },
    ],
  },
    ...
    subcategories: [
      { key: 'pipes', labelKey: 'catalog.pipes', descriptionKey: 'catalog.pipesDesc', iconName: 'Pipette', priceRange: { min: 40 },
        services: [
          ...
          { key: 'leak_fix', labelKey: 'catalog.leakFix', basePrice: 40, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
          { key: 'drain_cleaning', labelKey: 'catalog.drainCleaning', basePrice: 50, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'bathroom_install', labelKey: 'catalog.bathroomInstall', descriptionKey: 'catalog.bathroomInstallDesc', iconName: 'Bath', priceRange: { min: 40 },
        services: [
          ...
          { key: 'shower_install', labelKey: 'catalog.showerInstall', basePrice: 150, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
          { key: 'bathtub_install', labelKey: 'catalog.bathtubInstall', basePrice: 200, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
          { key: 'faucet_install', labelKey: 'catalog.faucetInstall', basePrice: 40, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'kitchen_plumbing', labelKey: 'catalog.kitchenPlumbing', descriptionKey: 'catalog.kitchenPlumbingDesc', iconName: 'CookingPot', priceRange: { min: 40 },
        services: [
          ...
          { key: 'garbage_disposal', labelKey: 'catalog.garbageDisposal', basePrice: 80, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'sewer', labelKey: 'catalog.sewer', descriptionKey: 'catalog.sewerDesc', iconName: 'Pipette', priceRange: { min: 60 },
        services: [
          ...
          { key: 'septic_service', labelKey: 'catalog.septicService', basePrice: 200, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
        ],
      },
    ],
  },
    ...
    subcategories: [
      { key: 'ac_services', labelKey: 'catalog.acServices', descriptionKey: 'catalog.acServicesDesc', iconName: 'Wind', priceRange: { min: 50 },
        services: [
          ...
          { key: 'ac_maintenance', labelKey: 'catalog.acMaintenance', basePrice: 50, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'heating', labelKey: 'catalog.heating', descriptionKey: 'catalog.heatingDesc', iconName: 'Flame', priceRange: { min: 45 },
        services: [
          ...
          { key: 'heating_boiler_install', labelKey: 'catalog.boilerInstall', basePrice: 300, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'ventilation', labelKey: 'catalog.ventilation', descriptionKey: 'catalog.ventilationDesc', iconName: 'Wind', priceRange: { min: 60 },
        services: [
          ...
          { key: 'duct_install', labelKey: 'catalog.ductInstall', basePrice: 30, unit: 'meter', unitLabelKey: 'catalog.unitMeter' },
          { key: 'hood_install', labelKey: 'catalog.hoodInstall', basePrice: 80, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
        ],
      },
    ],
  },
    ...
    subcategories: [
      { key: 'mounting', labelKey: 'catalog.mounting', descriptionKey: 'catalog.mountingDesc', iconName: 'Hammer', priceRange: { min: 20 },
        services: [
          ...
          { key: 'curtain_rod', labelKey: 'catalog.curtainRod', basePrice: 25, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
          { key: 'mirror_mount', labelKey: 'catalog.mirrorMount', basePrice: 35, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'minor_repairs', labelKey: 'catalog.minorRepairs', descriptionKey: 'catalog.minorRepairsDesc', iconName: 'Wrench', priceRange: { min: 20 },
        services: [
          ...
          { key: 'caulking', labelKey: 'catalog.caulking', basePrice: 15, unit: 'meter', unitLabelKey: 'catalog.unitMeter' },
          { key: 'grout_repair', labelKey: 'catalog.groutRepair', basePrice: 20, unit: 'meter', unitLabelKey: 'catalog.unitMeter' },
      ...
      { key: 'handyman_assembly', labelKey: 'catalog.assemblyServices', descriptionKey: 'catalog.assemblyServicesDesc', iconName: 'Package', priceRange: { min: 30 },
        services: [
          ...
          { key: 'playground_assembly', labelKey: 'catalog.playgroundAssembly', basePrice: 150, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'outdoor', labelKey: 'catalog.outdoor', descriptionKey: 'catalog.outdoorDesc', iconName: 'TreePine', priceRange: { min: 30 },
        services: [
          ...
          { key: 'deck_repair', labelKey: 'catalog.deckRepair', basePrice: 50, unit: 'sqm', unitLabelKey: 'catalog.unitSqm' },
          { key: 'fence_repair', labelKey: 'catalog.fenceRepair', basePrice: 30, unit: 'meter', unitLabelKey: 'catalog.unitMeter' },
        ],
      },
    ],
  },
    ...
    subcategories: [
      { key: 'large_appliances', labelKey: 'catalog.largeAppliances', descriptionKey: 'catalog.largeAppliancesDesc', iconName: 'Monitor', priceRange: { min: 50 },
        services: [
          ...
          { key: 'dishwasher_repair', labelKey: 'catalog.dishwasherRepair', basePrice: 70, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
          { key: 'refrigerator_repair', labelKey: 'catalog.refrigeratorRepair', basePrice: 90, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'small_appliances', labelKey: 'catalog.smallAppliances', descriptionKey: 'catalog.smallAppliancesDesc', iconName: 'Zap', priceRange: { min: 30 },
        services: [
          ...
          { key: 'vacuum_repair', labelKey: 'catalog.vacuumRepair', basePrice: 45, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'appliance_installation', labelKey: 'catalog.applianceInstallation', descriptionKey: 'catalog.applianceInstallationDesc', iconName: 'Package', priceRange: { min: 40 },
        services: [
          ...
          { key: 'appliance_relocation', labelKey: 'catalog.applianceRelocation', basePrice: 80, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
        ],
      },
    ],
  },
    ...
    subcategories: [
      { key: 'wiring', labelKey: 'catalog.wiring', descriptionKey: 'catalog.wiringDesc', iconName: 'Cable', priceRange: { min: 25 },
        services: [
          ...
          { key: 'wiring_replacement', labelKey: 'catalog.wiringReplacement', basePrice: 15, unit: 'meter', unitLabelKey: 'catalog.unitMeter' },
          { key: 'junction_box', labelKey: 'catalog.junctionBox', basePrice: 40, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'lighting', labelKey: 'catalog.lighting', descriptionKey: 'catalog.lightingDesc', iconName: 'Lightbulb', priceRange: { min: 20 },
        services: [
          ...
          { key: 'led_strip', labelKey: 'catalog.ledStrip', basePrice: 20, unit: 'meter', unitLabelKey: 'catalog.unitMeter' },
      ...
      { key: 'smart_home', labelKey: 'catalog.smartHome', descriptionKey: 'catalog.smartHomeDesc', iconName: 'Wifi', priceRange: { min: 80 },
        services: [
          ...
          { key: 'smart_lighting_system', labelKey: 'catalog.smartLightingSystem', basePrice: 200, unit: 'set', unitLabelKey: 'catalog.unitSet' },
          { key: 'home_automation', labelKey: 'catalog.homeAutomation', basePrice: 100, unit: 'hour', unitLabelKey: 'catalog.unitHour' },
        ],
      },
    ],
  },
    ...
    subcategories: [
      { key: 'door_install', labelKey: 'catalog.doorInstallation', descriptionKey: 'catalog.doorInstallationDesc', iconName: 'DoorOpen', priceRange: { min: 60 },
        services: [
          ...
          { key: 'sliding_door', labelKey: 'catalog.slidingDoor', basePrice: 200, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'door_repair', labelKey: 'catalog.doorRepairSub', descriptionKey: 'catalog.doorRepairSubDesc', iconName: 'Wrench', priceRange: { min: 25 },
        services: [
          ...
          { key: 'door_sealing', labelKey: 'catalog.doorSealing', basePrice: 30, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'locks', labelKey: 'catalog.locks', descriptionKey: 'catalog.locksDesc', iconName: 'Lock', priceRange: { min: 30 },
        services: [
          ...
          { key: 'lock_repair', labelKey: 'catalog.lockRepairService', basePrice: 35, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
          { key: 'smart_lock', labelKey: 'catalog.smartLock', basePrice: 120, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'windows', labelKey: 'catalog.windowServices', descriptionKey: 'catalog.windowServicesDesc', iconName: 'Square', priceRange: { min: 30 },
        services: [
          ...
          { key: 'window_sealing', labelKey: 'catalog.windowSealing', basePrice: 30, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
          { key: 'mosquito_net', labelKey: 'catalog.mosquitoNet', basePrice: 40, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
        ],
      },
    ],
  },
    ...
    subcategories: [
      { key: 'assembly', labelKey: 'catalog.assembly', descriptionKey: 'catalog.assemblyDesc', iconName: 'Package', priceRange: { min: 30 },
        services: [
          ...
          { key: 'desk_assembly', labelKey: 'catalog.deskAssembly', basePrice: 40, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
          { key: 'shelf_assembly', labelKey: 'catalog.shelfAssembly', basePrice: 30, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
          { key: 'kitchen_cabinet', labelKey: 'catalog.kitchenCabinet', basePrice: 100, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'custom_furniture', labelKey: 'catalog.customFurniture', descriptionKey: 'catalog.customFurnitureDesc', iconName: 'Ruler', priceRange: { min: 200 },
        services: [
          ...
          { key: 'custom_shelving', labelKey: 'catalog.customShelving', basePrice: 300, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'furniture_repair', labelKey: 'catalog.furnitureRepair', descriptionKey: 'catalog.furnitureRepairDesc', iconName: 'Wrench', priceRange: { min: 30 },
        services: [
          ...
          { key: 'upholstery_repair', labelKey: 'catalog.upholsteryRepair', basePrice: 100, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
    ...
    subcategories: [
      { key: 'upholstery', labelKey: 'catalog.upholsteryCleaning', descriptionKey: 'catalog.upholsteryCleaningDesc', iconName: 'Sofa', priceRange: { min: 25 },
        services: [
          ...
          { key: 'mattress_cleaning', labelKey: 'catalog.mattressCleaning', basePrice: 50, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
          { key: 'chair_cleaning_chem', labelKey: 'catalog.chairCleaning', basePrice: 25, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
          { key: 'car_seat_cleaning', labelKey: 'catalog.carSeatCleaning', basePrice: 30, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
        ],
      ...
      { key: 'carpet', labelKey: 'catalog.carpetCleaningSub', descriptionKey: 'catalog.carpetCleaningSubDesc', iconName: 'Layers', priceRange: { min: 10 },
        services: [
          ...
          { key: 'carpet_stain_removal', labelKey: 'catalog.carpetStainRemoval', basePrice: 25, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
        ],
        addons: [stainProtectionAddon],
      },
      { key: 'curtains_cleaning', labelKey: 'catalog.curtainCleaningSub', descriptionKey: 'catalog.curtainCleaningSubDesc', iconName: 'Wind', priceRange: { min: 20 },
        services: [
          ...
          { key: 'curtain_steam', labelKey: 'catalog.curtainSteam', basePrice: 25, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
        ],
      },
    ],
  },
    ...
    subcategories: [
      { key: 'computer', labelKey: 'catalog.computer', descriptionKey: 'catalog.computerDesc', iconName: 'Monitor', priceRange: { min: 30 },
        services: [
          ...
          { key: 'virus_removal', labelKey: 'catalog.virusRemoval', basePrice: 40, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
          { key: 'data_recovery', labelKey: 'catalog.dataRecovery', basePrice: 100, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'network', labelKey: 'catalog.network', descriptionKey: 'catalog.networkDesc', iconName: 'Wifi', priceRange: { min: 30 },
        services: [
          ...
          { key: 'cable_management', labelKey: 'catalog.cableManagement', basePrice: 50, unit: 'hour', unitLabelKey: 'catalog.unitHour' },
      ...
      { key: 'smart_home_tech', labelKey: 'catalog.smartHomeTech', descriptionKey: 'catalog.smartHomeTechDesc', iconName: 'Wifi', priceRange: { min: 50 },
        services: [
          ...
          { key: 'security_camera', labelKey: 'catalog.securityCamera', basePrice: 80, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
      ...
      { key: 'peripheral', labelKey: 'catalog.peripheral', descriptionKey: 'catalog.peripheralDesc', iconName: 'Monitor', priceRange: { min: 30 },
        services: [
          ...
          { key: 'speaker_system', labelKey: 'catalog.speakerSystem', basePrice: 60, unit: 'set', unitLabelKey: 'catalog.unitSet' },
        ],
      },
    ],
  },
    ...
    subcategories: [
      ...
      { key: 'delivery', labelKey: 'catalog.delivery', descriptionKey: 'catalog.deliveryDesc', iconName: 'Package', priceRange: { min: 30 },
        services: [
          ...
          { key: 'construction_materials', labelKey: 'catalog.constructionMaterials', basePrice: 100, unit: 'set', unitLabelKey: 'catalog.unitSet' },
      ...
      { key: 'disposal', labelKey: 'catalog.disposal', descriptionKey: 'catalog.disposalDesc', iconName: 'Trash2', priceRange: { min: 40 },
        services: [
          ...
          { key: 'appliance_disposal', labelKey: 'catalog.applianceDisposal', basePrice: 40, unit: 'piece', unitLabelKey: 'catalog.unitPiece' },
          { key: 'construction_waste', labelKey: 'catalog.constructionWaste', basePrice: 150, unit: 'set', unitLabelKey: 'catalog.unitSet' },
        ],
      },
    ],
  },
